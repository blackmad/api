...
|`serveCompareFrontend`|*no*|true|if set to true, the [pelias compare frontend](https://github.com/pelias/compare) will be served from / and /frontend, pointing at the local instance, to add in on-server debugging. [example](https://pelias.github.io/compare/)
